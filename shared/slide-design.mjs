...
const slides=[...document.querySelectorAll('.weave-present-stage > .weave-slide')];let current=Math.max(0,Math.min(slides.length-1,(parseInt(location.hash.slice(1),10)||1)-1));
